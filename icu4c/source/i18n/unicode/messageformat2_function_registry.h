...
namespace message2 {
    ...
    private:
        ...
        void checkFunction(std::u16string_view) const;
    ...
    class U_I18N_API_CLASS FunctionContext : public UObject {
        public:
             ...
             * @deprecated This API is for technology preview only.
             */
            U_I18N_API const Function *getStandardFunction(const FunctionName &name,
                                                     UErrorCode &errorCode) const {
                if (U_FAILURE(errorCode)) return nullptr;
                const Function *p = standardFunctions.getFunction(name);
                if (p == nullptr) {
