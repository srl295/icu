...
namespace message2 {
    ...
    MessageFormatter::Builder&
    MessageFormatter::Builder::setBidiIsolationStrategy(UMFBidiIsolationStrategy strategy) {
    ...
    MessageFormatter::Builder&
    MessageFormatter::Builder::setBidiIsolationStyle(UMFBidiIsolationStyle style) {
            bidiStyle = style;
            return *this;
    }
