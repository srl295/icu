...
RBBICharMonkey::RBBICharMonkey() {
    ...
    partition.emplace_back("Extend_ConjunctExtender", UnicodeSet(uR"([\p{Grapheme_Cluster_Break=Extend}&[\p{Indic_Conjunct_Break=Extend}]])", status));
    partition.emplace_back("ExtendmConjunctLinkermConjunctExtender", UnicodeSet(uR"([\p{Grapheme_Cluster_Break=Extend}-\p{Indic_Conjunct_Break=Linker}-[\p{Indic_Conjunct_Break=Extend}]])", status));
    ...
    partition.emplace_back("ConjunctLinkermExtend", UnicodeSet(uR"([\p{Indic_Conjunct_Break=Linker}-\p{Grapheme_Cluster_Break=Extend}])", status));
    partition.emplace_back("LinkingConsonant", UnicodeSet(uR"([\p{Indic_Conjunct_Break=Consonant}])", status));
    partition.emplace_back("ExtPict", UnicodeSet(uR"([\p{Extended_Pictographic=True}])", status));
    partition.emplace_back("XXmConjunctLinkermLinkingConsonantmExtPict", UnicodeSet(uR"([\p{Grapheme_Cluster_Break=Other}-\p{Indic_Conjunct_Break=Linker}-\p{Indic_Conjunct_Break=Consonant}-\p{Extended_Pictographic=True}])", status));

    rules.push_back(std::make_unique<RegexRule>(uR"($sot ÷)", uR"(^)", u'÷', uR"()"));
    rules.push_back(std::make_unique<RegexRule>(uR"(÷ $eot)", uR"()", u'÷', uR"((?!.))"));
    ...
    rules.push_back(std::make_unique<RegexRule>(uR"($ConjunctLinker $ConjunctExtender* × $LinkingConsonant)", uR"(\p{Indic_Conjunct_Break=Linker} [\p{Indic_Conjunct_Break=Extend}]*)", u'×', uR"(\p{Indic_Conjunct_Break=Consonant})"));
    rules.push_back(std::make_unique<RegexRule>(uR"($ExtPict $Extend* $ZWJ × $ExtPict)", uR"(\p{Extended_Pictographic=True} \p{Grapheme_Cluster_Break=Extend}* \p{Grapheme_Cluster_Break=ZWJ})", u'×', uR"(\p{Extended_Pictographic=True})"));
    ...
    rules.push_back(std::make_unique<RegexRule>(uR"($Any ÷ $Any)", uR"(.)", u'÷', uR"(.)"));
...
RBBIWordMonkey::RBBIWordMonkey()
{
    ...
    partition.emplace_back("ALetter_ExtPict", UnicodeSet(uR"([\p{Word_Break=ALetter}&\p{Extended_Pictographic=True}])", status));
    partition.emplace_back("ALettermExtPict", UnicodeSet(uR"([\p{Word_Break=ALetter}-\p{Extended_Pictographic=True}])", status));
    ...
    partition.emplace_back("ExtPictmALetter", UnicodeSet(uR"([\p{Extended_Pictographic=True}-\p{Word_Break=ALetter}])", status));
    partition.emplace_back("WSegSpace", UnicodeSet(uR"([\p{Word_Break=WSegSpace}])", status));
    partition.emplace_back("XXmExtPict", UnicodeSet(uR"([\p{Word_Break=Other}-\p{Extended_Pictographic=True}])", status));
    ...
    rules.push_back(std::make_unique<RegexRule>(uR"($ZWJ × $ExtPict)", uR"(\p{Word_Break=ZWJ})", u'×', uR"(\p{Extended_Pictographic=True})"));
    ...
    RBBIMonkeyKind()
{
    ...
    rules.push_back(std::make_unique<RegexRule>(uR"([^ $SP $HY $HH] × $GL)", uR"([^ \p{Line_Break=Space} \p{Line_Break=Hyphen} \p{Line_Break=Unambiguous_Hyphen}])", u'×', uR"(\p{Line_Break=Glue})"));
    ...
    rules.push_back(std::make_unique<RegexRule>(uR"($ALL ÷)", uR"(.)", u'÷', uR"()"));
    rules.push_back(std::make_unique<RegexRule>(uR"(÷ $ALL)", uR"()", u'÷', uR"(.)"));
    // --- End of generated code. ---
