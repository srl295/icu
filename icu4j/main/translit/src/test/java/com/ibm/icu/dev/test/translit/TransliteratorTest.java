...
public class TransliteratorTest extends TestFmwk {
    ...
    public void TestChinese() {
        ...
        assertTransform(
                "Transform",
                "z\u00E0i chu\u00E0ng z\u00E0o Unicode zh\u012B qi\u00E1n",
                hanLatin,
                "\u5728\u5275\u9020Unicode\u4E4B\u524D");
    }
    ...
    public void TestRegistry() {
        ...
        // Need to remove these test-specific transliterators in order not to interfere with other
        // tests.
    ...
    /**
     * Create some inverses and confirm that they work. We have to be careful how we do this, since
     * the inverses will not be true inverses -- we can't throw any random string at the composition
     * of the transliterators and expect the identity function. F x F' != I. However, if we are
     * careful about the input, we will get the expected results.
     */
    @Test
    ...
    public void TestKeyboard() {
        Transliterator t =
                Transliterator.createFromRules(
                        "<ID>", "psch>Y;" + "ps>y;" + "ch>x;" + "a>A;", Transliterator.FORWARD);
        String DATA[] = {
            // insertion, buffer
            "a",
            "A",
            ...
            "AycAY",
            null,
            "AycAY", // null means finishKeyboardTransliteration
        };
    ...
    public void TestKeyboard2() {
        Transliterator t =
                Transliterator.createFromRules(
                        "<ID>", "ych>Y;" + "ps>|y;" + "ch>x;" + "a>A;", Transliterator.FORWARD);
        String DATA[] = {
            // insertion, buffer
            "a",
            "A",
            ...
            "Ap",
            "s",
            "Aps", // modified for rollback - "Ay",
            "c",
            "Apsc", // modified for rollback - "Ayc",
            "a",
            "AycA",
            "p",
            "AycAp",
            "s",
            "AycAps", // modified for rollback - "AycAy",
            "c",
            "AycApsc", // modified for rollback - "AycAyc",
            "h",
            "AycAY",
            null,
            "AycAY", // null means finishKeyboardTransliteration
    ...
    public void TestKeyboard3() {
        ...
        String[] DATA = {
            ...
            "ab",
            "t",
            "abt", // modified for rollback - "aby",
            "c",
            "abyc",
            "t",
            "abyct", // modified for rollback - "abycy",
            "h",
            "abycz",
            null,
            "abycz", // null means finishKeyboardTransliteration
        };
    ...
    private void keyboardAux(Transliterator t, String[] DATA) {
        ...
        for (int i = 0; i < DATA.length; i += 2) {
            StringBuilder log;
            if (DATA[i] != null) {
                log = new StringBuilder(s.toString() + " + " + DATA[i] + " -> ");
    ...
    /**
     * Compose the Kana transliterator forward and reverse and try some strings that should come out
     * unchanged.
     */
    @Test
    ...
    public void TestFiltering() {
        ...
        Transliterator tempTrans =
                Transliterator.createFromRules("temp", "x > y; x{a} > b; ", Transliterator.FORWARD);
        ...
        tempTrans =
                Transliterator.createFromRules(
                        "temp", "::[a]; x > y; x{a} > b; ", Transliterator.FORWARD);
    ...
    public void TestPatternQuoting() {
        ...
        for (int i = 0; i < DATA.length; i += 3) {
            ...
            Transliterator t =
                    Transliterator.createFromRules("<ID>", DATA[i], Transliterator.FORWARD);
    ...
    public void TestVariableNames() {
        Transliterator gl =
                Transliterator.createFromRules(
                        "foo5", "$\u2DC0 = qy; a>b;", Transliterator.FORWARD);
        if (gl == null) {
    ...
    //        // \\uXXXX and &#xXXXX;
    //        HexToUnicodeTransliterator hex2 = new
    // HexToUnicodeTransliterator("\\\\u###0;&\\#x###0\\;");
    ...
    public void TestJ329() {
        ...
        for (int i = 0; i < DATA.length; i += 2) {
            ...
            try {
                Transliterator.createFromRules(
                        "<ID>", (String) DATA[i + 1], Transliterator.FORWARD);
            } catch (IllegalArgumentException e) {
                err = e.getMessage();
            }
            boolean gotError = (err != null);
            String desc =
                    (String) DATA[i + 1] + (gotError ? (" -> error: " + err) : " -> no error");
    ...
    public void TestSegments() {
        ...
        // Each item is <rules>, <input>, <expected output>
        String[] DATA = {
            "([a-z]) '.' ([0-9]) > $2 '-' $1", "abc.123.xyz.456", "ab1-c23.xy4-z56",
        };
    ...
    /**
     * Test zero length and > 1 char length variable values. Test use of variable refs in
     * UnicodeSets.
     */
    @Test
    ...
    public void TestPositionHandling() {
        ...
        for (int i = 0; i < n; i++) {
            Transliterator t =
                    Transliterator.createFromRules("<ID>", DATA[3 * i], Transliterator.FORWARD);
            ...
            expectAux(
                    Utility.escape(DATA[3 * i]), DATA[3 * i + 1], result, result.equals(exp), exp);
        }
    }
    ...
    public void TestNameMap() {
        ...
        expect(
                name2uni,
                "{\\N { NO-BREAK SPACE}abc\\N{  CJK UNIFIED  IDEOGRAPH-4E01  }\\N{x\\N{MICRO SIGN}\\N{GUJARATI SIGN CANDRABINDU}\\N{REPLACEMENT CHARACTER}\\N{<control-0004>}\\N{<control-0009>}\\N{<control-0081>}\\N{<noncharacter-FFFF>}\\N{<control-0004>}\\N{",
                "{\u00A0abc\u4E01\\N{x\u00B5\u0A81\uFFFD\u0004\u0009\u0081\uFFFF\u0004\\N{");
    ...
    public void TestCreateInstance() {
        ...
        String DATA[] = {
            ...
            REVERSE,
            "",
            "InvalidSource-InvalidTarget;Hex-Any",
            FORWARD,
            "",
            "InvalidSource-InvalidTarget;Hex-Any",
            REVERSE,
    ...
    /**
     * Compound filter semantics were originally not implemented correctly. Originally, each
     * component filter f(i) is replaced by f'(i) = f(i) && g, where g is the filter for the
     * compound transliterator.
     *
     * <p>From Mark:
     *
     * <p>Suppose and I have a transliterator X. Internally X is "Greek-Latin; Latin-Cyrillic;
     * Any-Lower". I use a filter [^A].
     *
     * <p>The compound should convert all greek characters (through latin) to cyrillic, then
     * lowercase the result. The filter should say "don't touch 'A' in the original". But because an
     * intermediate result happens to go through "A", the Greek Alpha gets hung up.
     */
    @Test
    ...
    public void TestToRules() {
        ...
        for (int d = 0; d < DATA.length; d += 3) {
            if (DATA[d].equals(RBT)) {
                // Transliterator test
                Transliterator t =
                        Transliterator.createFromRules("ID", DATA[d + 1], Transliterator.FORWARD);
                if (t == null) {
                    errln("FAIL: createFromRules failed");
                    return;
                }
    ...
    public void TestSupplemental() {
        ...
        expect(
                Transliterator.getInstance("Any-Name"),
        ...
        expect(
                Transliterator.getInstance("Any-Hex/Unicode"),
                CharsToUnicodeString("\\U00010330\\U0010FF00\\U000E0061\\u00A0"),
                "U+10330U+10FF00U+E0061U+00A0");

        expect(
                Transliterator.getInstance("Any-Hex/C"),
                CharsToUnicodeString("\\U00010330\\U0010FF00\\U000E0061\\u00A0"),
                "\\U00010330\\U0010FF00\\U000E0061\\u00A0");

        expect(
                Transliterator.getInstance("Any-Hex/Perl"),
                CharsToUnicodeString("\\U00010330\\U0010FF00\\U000E0061\\u00A0"),
                "\\x{10330}\\x{10FF00}\\x{E0061}\\x{A0}");

        expect(
                Transliterator.getInstance("Any-Hex/Java"),
                CharsToUnicodeString("\\U00010330\\U0010FF00\\U000E0061\\u00A0"),
                "\\uD800\\uDF30\\uDBFF\\uDF00\\uDB40\\uDC61\\u00A0");

        expect(
                Transliterator.getInstance("Any-Hex/XML"),
                CharsToUnicodeString("\\U00010330\\U0010FF00\\U000E0061\\u00A0"),
                "&#x10330;&#x10FF00;&#xE0061;&#xA0;");

        expect(
                Transliterator.getInstance("Any-Hex/XML10"),
                CharsToUnicodeString("\\U00010330\\U0010FF00\\U000E0061\\u00A0"),
                "&#66352;&#1113856;&#917601;&#160;");

        expect(
                Transliterator.getInstance("[\\U000E0000-\\U000E0FFF] Remove"),
                CharsToUnicodeString("\\U00010330\\U0010FF00\\U000E0061\\u00A0"),
    ...
    static class TestFact implements Transliterator.Factory {
        static class NameableNullTrans extends Transliterator {
            ...
            @Override
            protected void handleTransliterate(
                    Replaceable text, Position offsets, boolean incremental) {
    ...
    public void TestSTV() {
        ...
        for (Enumeration<String> e = Transliterator.getAvailableSources(); e.hasMoreElements(); ) {
    ...
    public void TestCompoundInverse() {
        Transliterator t =
                Transliterator.getInstance("Greek-Latin; Title()", Transliterator.REVERSE);
        if (t == null) {
        ...
        if (t.getID().equals(exp)) {
            ...
            errln(
                    "FAIL: inverse of \"Greek-Latin; Title()\" is \""
                            + t.getID()
                            + "\", expected \""
                            + exp
                            + "\"");
    ...
    public void TestNFDChainRBT() {
        Transliterator t =
                Transliterator.createFromRules(
                        "TEST", "::NFD; aa > Q; a > q;", Transliterator.FORWARD);
    ...
    public void TestUndefinedVariable() {
        ...
        try {
            ...
            logln("OK: Got exception for " + rule + ", as expected: " + e.getMessage());
            return;
        }
    ...
    public void TestCompoundFilterID() {
        String[] DATA = {
            ...
            "[b]; (Lower); Latin-Greek; Upper(); ([\u0392])", "R", "\u0391\u0392\u0393",
                    "\u0391b\u0393",
            "#\n::[b]; ::Latin-Greek; ::Upper; ::([xyz]);", "F", "abc", "a\u0392c",
        ...
        for (int i = 0; i < DATA.length; i += 4) {
            String id = DATA[i];
            int direction =
                    (DATA[i + 1] != null && DATA[i + 1].charAt(0) == 'R')
    ...
    public void TestNewEngine() {
        ...
        expect(
                "$smooth = x; $macron = q; [:^L:] { ([aeiouyAEIOUY] $macron?) } [^aeiouyAEIOUY$smooth$macron] > | $1 $smooth ;",
                "a",
                "ax");
    ...
    public void TestDevanagariLatinRT() {
        ...
        Transliterator latinToDev =
                Transliterator.getInstance("Latin-Devanagari", Transliterator.FORWARD);
        Transliterator devToLatin =
                Transliterator.getInstance("Devanagari-Latin", Transliterator.FORWARD);
    ...
    public void TestTeluguLatinRT() {
        ...
        Transliterator latinToDev =
                Transliterator.getInstance("Latin-Telugu", Transliterator.FORWARD);
        Transliterator devToLatin =
                Transliterator.getInstance("Telugu-Latin", Transliterator.FORWARD);
    ...
    public void TestCompoundLatinRT() {
        ...
        Transliterator latinToDevToLatin =
                Transliterator.getInstance(
                        "Latin-Devanagari;Devanagari-Latin", Transliterator.FORWARD);
        Transliterator devToLatinToDev =
                Transliterator.getInstance(
                        "Devanagari-Latin;Latin-Devanagari", Transliterator.FORWARD);
        for (int i = 0; i < MAX_LEN; i++) {
    ...
    public void TestLocaleInstantiation() {
        ...
        try {
            ...
            warnln(
                    "Could not load locale data for obtaining the script used in the locale te_IN. "
                            + ex.getMessage());
        }
        try {
            ...
            warnln(
                    "Could not load locale data for obtaining the script used in the locale ru_RU. "
                            + ex.getMessage());
        }
        try {
            ...
            warnln(
                    "Could not load locale data for obtaining the script used in the locale el. "
                            + ex.getMessage());
        }
    }
    ...
    /**
     * Test the use variable range pragma, making sure that use of variable range characters is
     * detected and flagged as an error.
     */
    @Test
    ...
    public void TestToRulesMark() {
        ...
        Transliterator t2 =
                Transliterator.createFromRules("source-target", testRules, Transliterator.FORWARD);
        Transliterator t3 =
                Transliterator.createFromRules("target-source", testRules, Transliterator.REVERSE);
    ...
    public void TestDisplayName() {
        ...
        for (int i = 0; i < DATA.length; i += 3) {
            ...
            if (!name.equals(name2)) errln("FAIL: getDisplayName with default locale failed");
    ...
    /**
     * This test is not in trnstst.cpp. This test has been moved from
     * com/ibm/icu/dev/test/lang/TestUScript.java during ICU4J modularization to remove dependency
     * of tests on Transliterator.
     */
    @Test
    ...
    static final String[][] testCases = {
        ...
        {
            "Title",
            "ab'cD ffi\u0131I\u0130 \u01C7\u01C8\u01C9 " + DESERET_dee + DESERET_DEE,
        ...
        {
            "Upper",
            "ab'cD \uFB00i\u0131I\u0130 \u01C7\u01C8\u01C9 " + DESERET_dee + DESERET_DEE,
    ...
    public void TestSpecialCases() {
        ...
        for (int i = 0; i < registerRules.length; ++i) {
            Transliterator t =
                    Transliterator.createFromRules(
                            registerRules[i][0], registerRules[i][1], Transliterator.FORWARD);
        ...
        for (int i = 0; i < testCases.length; ++i) {
            ...
            // Automatic generation of targets, to make it simpler to add test cases (and more
            // fail-safe)
            ...
            if (testCases[i].length > 2) target = testCases[i][2];
                ...
                target =
                        com.ibm.icu.text.Normalizer.normalize(
                                source, com.ibm.icu.text.Normalizer.NFD);
            else if (id.equalsIgnoreCase("NFC"))
                target =
                        com.ibm.icu.text.Normalizer.normalize(
                                source, com.ibm.icu.text.Normalizer.NFC);
            else if (id.equalsIgnoreCase("NFKD"))
                target =
                        com.ibm.icu.text.Normalizer.normalize(
                                source, com.ibm.icu.text.Normalizer.NFKD);
            else if (id.equalsIgnoreCase("NFKC"))
                target =
                        com.ibm.icu.text.Normalizer.normalize(
                                source, com.ibm.icu.text.Normalizer.NFKC);
    ...
    public void TestSurrogateCasing() {
        ...
        if (!UTF16.valueOf(DEE).equals(DESERET_DEE)) {
            errln(
                    "Fails titlecase of surrogates"
                            + Integer.toString(dee, 16)
                            + ", "
                            + Integer.toString(DEE, 16));
        }
    ...
    public void TestInvalidBackRef() {
        ...
        try {
            ...
            Transliterator t2 =
                    Transliterator.createFromRules("Test2", rule2, Transliterator.FORWARD);
            if (t2 != null) {
                errln("FAIL: createFromRules should have returned NULL");
            }
            errln("FAIL: Ok: . > $1; => no error");
    ...
    public void TestUserFunction() {
        ...
        TestUserFunctionFactory.add(
                "Any-RemoveCurly",
                Transliterator.createFromRules(
                        "RemoveCurly", "[\\{\\}] > ; \\\\N > ;", Transliterator.FORWARD));
        ...
        t =
                Transliterator.createFromRules(
                        "gif2", "(.) > &Gif(&Hex2($1));", Transliterator.FORWARD);
        logln("Registering");
        ...
        expect(
                t,
                "ab",
                "<img src=\"http://www.unicode.org/gifs/24/00/U0061.gif\">"
    ...
    public void TestAny() {
        ...
        for (int i = 0; i < UScript.CODE_LIMIT; ++i) {
            UnicodeSet sample =
                    new UnicodeSet()
                            .applyPropertyAlias("script", UScript.getShortName(i))
    ...
    /**
     * Test the source and target set API. These are only implemented for RBT and
     * CompoundTransliterator at this time.
     */
    @Test
        ...
        if (src.equals(expSrc) && trg.equals(expTrg)) {
            ...
            errln(
                    "FAIL: "
                            ...
                            + src.toPattern(true)
                            + ", expected "
                            + expSrc.toPattern(true)
                            + "; target = "
                            + trg.toPattern(true)
                            + ", expected "
                            + expTrg.toPattern(true));
        }
    }
        ...
        for (String[] testPair : tests) {
            ...
            for (Transliterator t : new Transliterator[] {t0, t1}) {
                ...
                UnicodeSet expectedTarget =
                        testPair.length <= targetIndex
                                ? expectedSource
                                : testPair[targetIndex] == null
                                        ? expectedSource
                                        : testPair[targetIndex].length() == 0
                                                ? expectedSource
    ...
    static void addSourceTarget(
            String s, UnicodeSet expectedSource, String t, UnicodeSet expectedTarget) {
    ...
    public void TestCharUtils() {
        ...
        for (String[] row : startTests) {
            ...
            assertEquals(
                    "findSharedStartLength(" + row[1] + "," + row[2] + ")",
        ...
        for (String[] row : endTests) {
            ...
            assertEquals(
                    "findSharedEndLength(" + row[1] + "," + row[2] + ")",
                    Integer.parseInt(row[0]),
                    actual);
        }
    }
    ...
    private static int findSharedStartLength(CharSequence s, CharSequence t) {
        ...
        return CharSequences.onCharacterBoundary(s, i) && CharSequences.onCharacterBoundary(t, i)
                ? i
                : i - 1;
    }
    ...
    private static int findSharedEndLength(CharSequence s, CharSequence t) {
        ...
        int i;
        char sch, tch;
        // TODO can make the calculations slightly faster... Not sure if it is worth the
        // complication, tho'
        for (i = 0; i < min; ++i) {
        ...
        return CharSequences.onCharacterBoundary(s, slength - i)
                        && CharSequences.onCharacterBoundary(t, tlength - i)
                ? i
                : i - 1;
    }
    ...
    static void assertEquals(
            String message, UnicodeSet empirical, UnicodeSet actual, SetAssert setAssert) {
    ...
    private static final String[] BEGIN_END_RULES =
            new String[] {
                // [0]
                "abc > xy;" + "aba > z;",
                ...
                + "::END;",
                 */
                "", // test case commented out below, this is here to keep from messing up the
                // indexes
    ...
    private static final String[] BEGIN_END_TEST_CASES =
            new String[] {
    ...
    public void TestBeginEnd() {
        ...
        for (int i = 0; i < BEGIN_END_TEST_CASES.length; i += 3) {
            expect(
                    BEGIN_END_TEST_CASES[i],
                    BEGIN_END_TEST_CASES[i + 1],
                    BEGIN_END_TEST_CASES[i + 2]);
        }

        // instantiate the one reversible rule set in the reverse direction and make sure it does
        // the right thing
        Transliterator reversed =
                Transliterator.createFromRules(
                        "Reversed", BEGIN_END_RULES[17], Transliterator.REVERSE);
    ...
    public void TestBeginEndToRules() {
        ...
        // instantiating a Transliterator from the rules and running the test against it, we
        // instantiate
        // a Transliterator from the rules, do toRules() on it, instantiate a Transliterator from
        // the resulting set of rules, and make sure that the generated rule set is semantically
        // equivalent
        // to (i.e., does the same thing as) the original rule set
        for (int i = 0; i < BEGIN_END_TEST_CASES.length; i += 3) {
            Transliterator t =
                    Transliterator.createFromRules(
                            "--", BEGIN_END_TEST_CASES[i], Transliterator.FORWARD);
            String rules = t.toRules(false);
            Transliterator t2 =
                    Transliterator.createFromRules(
                            "Test case #" + (i / 3), rules, Transliterator.FORWARD);
        ...
        Transliterator reversed2 =
                Transliterator.createFromRules("Reversed", rules, Transliterator.FORWARD);
    ...
    /**
     * Test Thai. The text is the first paragraph of "What is Unicode" from the Unicode.org web
     * site. TODO: confirm that the expected results are correct. For now, test just confirms that
     * C++ and Java give identical results.
     */
    @Test
    ...
    // ======================================================================
    static void expect(
            String rules, String source, String expectedResult, Transliterator.Position pos) {
        Transliterator t = Transliterator.createFromRules("<ID>", rules, Transliterator.FORWARD);
    ...
    static void expect(
            Transliterator t, String source, String expectedResult, Transliterator.Position pos) {
        if (pos == null) {
        ...
        if (pos == null) {
            ...
            index =
                    new Transliterator.Position(
                            pos.contextStart, pos.contextLimit, pos.start, pos.limit);
        }
        ...
        if (index.start != index.limit) {
            expectAux(
                    t.getID() + ":UNFINISHED",
                    source,
                    "start: " + index.start + ", limit: " + index.limit,
                    false,
                    expectedResult);
            return;
        }
        ...
        if (pos != null) {
            ...
            for (int i = 0; i < source.length(); ++i) {
                ...
                v.add(
                        UtilityExtensions.formatInput(rsource, index)
                                + ((i < source.length() - 1)
                                        ? (" + '" + source.charAt(i + 1) + "' ->")
                                        : " =>"));
            }
        ...
        v.toArray(results);
        expectAux(
                t.getID() + ":Incremental", results, result.equals(expectedResult), expectedResult);
    }

    static boolean expectAux(String tag, String source, String result, String expectedResult) {
        return expectAux(
                tag, new String[] {source, result}, result.equals(expectedResult), expectedResult);
    }

    static boolean expectAux(
            String tag, String source, String result, boolean pass, String expectedResult) {
        return expectAux(tag, new String[] {source, result}, pass, expectedResult);
    }

    static boolean expectAux(String tag, String source, boolean pass, String expectedResult) {
        return expectAux(tag, new String[] {source}, pass, expectedResult);
    }

    static boolean expectAux(String tag, String[] results, boolean pass, String expectedResult) {
    ...
    public void TestGetAvailableTargets() {
        try {
            ...
            errln(
                    "TransliteratorRegistry.getAvailableTargets(String) was not "
    ...
    public void TestGetAvailableVariants() {
        try {
            ...
            errln(
                    "TransliteratorRegistry.getAvailableVariants(String) was not "
                            + "supposed to return an exception.");
        }
    }
    ...
    public void TestNextLine() {
        ...
        try {
            ...
            errln(
                    "TransliteratorParser.nextLine() was not suppose to return an "
    ...
    public void TestPositionEquals() {
        ...
        assertNotEquals(
                "2 different positions have different hash codes",
                position1.hashCode(),
                position2.hashCode());
        ...
        assertEquals(
                "2 positions have the same hash codes", position1.hashCode(), position3.hashCode());
    }
}
